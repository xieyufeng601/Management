...
public partial class SysUserRoleBll
{
   ...
   private readonly ISysUserRoleManager dal;

     public SysUserRoleBll()
        {
            dal = DataAccess.CreatebaseSysUserRole() ?? throw new ArgumentNullException(nameof(dal));
        }
     ...
     #region
       /// <summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual SysUserRole _GetById(object id)
        {
