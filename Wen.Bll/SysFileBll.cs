...
public partial class SysFileBll
{

                                              
   private readonly ISysFileManager dal;

     public SysFileBll()
        {
            dal = DataAccess.CreatebaseSysFile() ?? throw new ArgumentNullException(nameof(dal));
        }
     ...
     #region
       /// <summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual SysFile _GetById(object id)
        {
