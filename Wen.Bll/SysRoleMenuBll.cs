...
public partial class SysRoleMenuBll
{

                                              
   private readonly ISysRoleMenuManager dal;

     public SysRoleMenuBll()
        {
            dal = DataAccess.CreatebaseSysRoleMenu() ?? throw new ArgumentNullException(nameof(dal));
        }
     ...
     #region
       /// <summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual SysRoleMenu _GetById(object id)
        {
